        ...
        <div className="secure-container">
            ...
            <div className="secure-content">
                ...
                <div className="step-image">
                    <img src="/img/threedot-menu.png" alt="Three Dot Menu" />
                </div>
                <div className="step-info">
                    <h3>Step 2</h3>
                ...
                <div className="step-image">
                    <img src="/img/privacy_security.png" alt="Privacy and Security" className="signin-img" />
                </div>
                ...
                <div className="step-image">
                    <img src='/img/delete_data.png' alt="Delete Browsing Data" />
                </div>
                ...
                <div className="step-image">
                    <img src="/img/data_tab.png" alt="Delete Data Tab" className="signin-img" />
                </div>
