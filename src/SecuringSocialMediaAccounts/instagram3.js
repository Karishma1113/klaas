...
/>
      ...
      <div className="steps-container">
        ...
        <div className="step-block">
          <p>
            <strong>3.</strong> Tap <strong>Where You're Logged In</strong> to review account activity and see all devices currently logged into your account.
          </p>
        ...
        <div className="step-block">
          <p>
            <strong>4.</strong> Log out from any unknown devices and change your password immediately if you notice suspicious activity.
          </p>
